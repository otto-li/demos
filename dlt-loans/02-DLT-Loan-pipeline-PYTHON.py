...
# MAGIC
# MAGIC **Your DLT Pipeline is ready!** Your pipeline was started using the SQL notebook and is <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/5e7b6779-6cd9-4d31-a8aa-369648a2f078">available here</a>.
# MAGIC
...
def raw_txs():
  return (
    spark.readStream.format("cloudFiles")
      ...
      .load("/Volumes/otto/dlt-full/raw_data/raw_transactions"))

# COMMAND ----------

@dlt.create_table(comment="Lookup mapping for accounting codes")
def ref_accounting_treatment():
  return spark.read.format("delta").load("/Volumes/otto/dlt-full/raw_data/ref_accounting_treatment")
...
def raw_historical_loans():
  return (
    spark.readStream.format("cloudFiles")
      ...
      .option("cloudFiles.inferColumnTypes", "true")
      .load("/Volumes/otto/dlt-full/raw_data/historical_loans"))
...
# MAGIC %md ## Next steps
# MAGIC
# MAGIC Your DLT pipeline is ready to be started. <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/5e7b6779-6cd9-4d31-a8aa-369648a2f078">Click here to access the pipeline</a> created for you using the SQL notebook.
# MAGIC
