...
-- MAGIC
-- MAGIC **Your DLT Pipeline is ready!** Your pipeline was started using this notebook and is <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/5e7b6779-6cd9-4d31-a8aa-369648a2f078">available here</a>.
-- MAGIC
...
-- %fs ls /Volumes/otto/dlt-full/raw_data/raw_transactions
...
AS SELECT * FROM cloud_files('/Volumes/otto/dlt-full/raw_data/raw_transactions', 'json', map("cloudFiles.inferColumnTypes", "true"))
...
AS SELECT * FROM delta.`/Volumes/otto/dlt-full/raw_data/ref_accounting_treatment`
...
AS SELECT * FROM cloud_files('/Volumes/otto/dlt-full/raw_data/historical_loans', 'csv', map("cloudFiles.inferColumnTypes", "true"))
...
-- MAGIC %md ## Next steps
-- MAGIC
-- MAGIC Your DLT pipeline is ready to be started. <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/5e7b6779-6cd9-4d31-a8aa-369648a2f078">Click here to access the pipeline</a> created for you using this notebook.
-- MAGIC
...
-- MAGIC
-- MAGIC <a dbdemos-dashboard-id="dlt-expectations" href='/sql/dashboardsv3/01ef5ab1b1bc1019b73afff409c190a7' target="_blank">Data Quality Dashboard example</a>
